...
const Index = () => {
  ...
  }, [analyzed, frames, beamsWithLoads, columns, mat, effectiveFrameEndReleases, slabs, slabProps, beamStiffnessFactor, colStiffnessFactor, colRigidEndOffsets, manualJointOverrides, state.ribbedSlabProps]);
  ...
  }, [analyzed, frames, beamsWithLoads, columns, mat, colLoadsBiaxial, effectiveFrameEndReleases, autoDetectedConnections, slabs, slabProps, beamStiffnessFactor, colStiffnessFactor, colRigidEndOffsets, manualJointOverrides, state.ribbedSlabProps]);
                  ...
                  <div className="flex items-center gap-2 px-3 py-2 border-b border-border bg-muted/30 shrink-0">
                    ...
                    {modelerElevation !== -1 && (
                      <Badge variant="outline" className="text-[10px]">
                        {modelerElevation === minStoryElev ? 'مسقط الأساسات والركائز' : `المنسوب ${(modelerElevation / 1000).toFixed(1)} م`}
                      </Badge>
                    )}
                  </div>
                );
